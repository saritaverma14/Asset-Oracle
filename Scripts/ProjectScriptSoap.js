function GetProject() {
    ...
    var url = "http://" + window.location.host + "/Asset-Oracle/Soap/Project?Program=" + Program;
    $.get(url, function (data) {
        ...
        $.ajax({
            type: "POST",
            url: "/Asset-Oracle/Soap/SoapIndex",
...
function GetRelease() {
    ...
    var url = "http://" + window.location.host + "/Asset-Oracle/Soap/Release?Project=" + Project + "& Program=" + Program;
    $.get(url, function (data) {
...
function GetOperation() {
    ...
    var url = "http://" + window.location.host + "/Asset-Oracle/Soap/Operation?Release=" + Release;
    $.get(url, function (data) {
...
function GetSprint() {
    ...
    var url = "http://" + window.location.host + "/Asset-Oracle/Soap/Sprint?Operation=" + Operation;
    $.get(url, function (data) {
...
$(document).ready(function () {
    $("#CopySoap").click(function (event) {
        ...
        if ($(':checkbox:checked').length <= 0) {
            ...
            PopUp1 = window.open('../Soap/_CopyDetailSoap/?ArrayIds=' + trimStr + '', null, 'titlebar=0, width=440,height =350,left=500,top=175,scrollbars=no').split('&');
            PopUp1.focus();
            event.preventDefault();
            return false;
        }
