function GetProject() {
    ...
    var url = "http://" + window.location.host + "/Asset-Oracle/Service/Project?Program=" + Program;
    $.get(url, function (data) {
        ...
        $.ajax({
            type: "POST",
            url: "/Asset-Oracle/Service/Index",
...
function GetRelease() {
    ...
    var url = "http://" + window.location.host + "/Asset-Oracle/Service/Release?Project=" + Project + "& Program=" + Program;
    $.get(url, function (data) {
...
function GetApiOperation() {
    ...
    var url = "http://" + window.location.host + "/Asset-Oracle/Service/ApiOperation?Release=" + Release;
    $.get(url, function (data) {
...
function GetSprint() {
    ...
    var url = "http://" + window.location.host + "/Asset-Oracle/Service/Sprint?ApiOperation=" + ApiOperation;
    $.get(url, function (data) {
...
$(document).ready(function () {
    $("#Copy").click(function (event) {
        ...
        if ($(':checkbox:checked').length <= 0) {
            ...
            PopUp1 = window.open('../Service/_CopyDetail/?ArrayIds=' + trimStr + '', null, 'titlebar=0, width=440,height =350,left=500,top=175,scrollbars=no').split('&');
            PopUp1.focus();
            event.preventDefault();
            return false;
        }
